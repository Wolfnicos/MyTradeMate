...
public final class WebSocketManager {
    ...
    private func handleMessage(_ message: URLSessionWebSocketTask.Message) {
        ...
        case .string(let text):
            ...
            guard !text.isEmpty else {
                ErrorManager.shared
                    .handle(
                        .webSocketInvalidMessage(message: "Empty message"),
                        context: "WebSocketManager.handleMessage"
                    )
                return
            }
        ...
        @unknown default:
            ...
            ErrorManager.shared
                .handle(
                    .webSocketInvalidMessage(message: "Unknown message type"),
                    context: "WebSocketManager.handleMessage"
                )
        }
    }
    ...
    private func handleConnectionLoss(error: Error) async {
        ...
        ErrorManager.shared
            .handle(
                .webSocketConnectionFailed(reason: error.localizedDescription),
                context: "WebSocketManager.handleConnectionLoss"
            )
